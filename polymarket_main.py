...
def build_config() -> AgentConfig:
    ...
    return AgentConfig(
        ...
        fast_lane_minutes     = _int  ("POLY_FAST_LANE_MINUTES",     5),
        fast_lane_min_prob    = _float("POLY_FAST_LANE_MIN_PROB",    0.80),
        fast_lane_min_edge    = _float("POLY_FAST_LANE_MIN_EDGE",    0.02),
        price_refresh         = True,
